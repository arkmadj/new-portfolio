...
export default function Home() {
	return (
		<div className="max-h-[10000px] overflow-hidden main-content">
				...
				<main>
					...
					<section className="flex flex-col gap-8 mb-[66px] text-xl font-sans">
						<p>
							...
							Nigeria. My focus is on creating interactive digital experiences
							on the web, and I have collaborated with teams across the world to
							achieve this goal. I have experience working with frameworks such
							as React, ReactNative, Vue, Go, TypeScript, JavaScript, Python,
							and Rust.
						</p>
						<p>
							In addition to being a software engineer, I am also an illustrator
							and enjoy drawing and character design. I have worked with
							personal care brands, among others. You can find some of my work
							here.
						</p>
						<p>
