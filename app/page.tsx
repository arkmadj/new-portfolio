...
export default function Home() {
	return (
		<main className="max-h-[10000px] overflow-hidden">
			<div className="min-h-screen w-[1300px] ms-auto me-auto">
				...
				<section className="flex flex-col gap-8 mb-[66px] text-xl font-sans">
					<p>
						...
						React, ReactNative, Vue, Go, TypeScript, JavaScript, Python, and
						Rust.
					</p>
					<p>
						In addition to being a software engineer, I am also an illustrator
						and enjoy drawing and character design. I have worked with personal
						care brands, among others. You can find some of my work here.
					</p>
					<p>
